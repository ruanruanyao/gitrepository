		...
		<form action="${path }/book/addBook" method="post" enctype="multipart/form-data">
			<table>
				<tr>
					...
					<td>页数：</td>
					<td><input type="number" name="" class="el-input__inner"></td>
				</tr>
				<tr>
					<td>所属分类：</td>
					<td>
						<select name="book.cate_id" class="el-select__inner inner2">
						<c:forEach items="${TwoCategory }" var="c">
				...
				<tr>
					...
					<td>内容简介：</td>
					<td rowspan="2"><textarea class="el-textarea__inner" name=""></textarea></td>
				</tr>
				<tr>
					<td>版次：</td>
					<td><input type="text" name="book.public_count" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>印刷时间：</td>
				...
				<tr>
					<td>印次：</td>
					<td><input type="text" name="book.print_count" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>ISBN：</td>
				...
				<tr>
					<td>开本：</td>
					<td><input type="text" name="" class="el-input__inner"></td>
					<td></td>
				</tr>
				<tr>
					<td>纸张：</td>
